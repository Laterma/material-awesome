...
```
yay -S awesome rofi picom i3lock-fancy xclip kitty ttf-roboto polkit-gnome materia-theme lxappearance flameshot pnmixer network-manager-applet xfce4-power-manager qt5-styleplugins papirus-icon-theme -y
```
...
```
git clone https://github.com/Laterma/material-awesome.git ~/.config/awesome
```
...
```
git clone -b lua5.4 https://github.com/Laterma/material-awesome.git ~/.config/awesome
```

Awesome4.3-stable (older version with less features, no longer maintained, browse the branch for install requirements!)
```
git clone -b awesome4.3-stable https://github.com/Laterma/material-awesome.git ~/.config/awesome
```
